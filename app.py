...
def home():
    ...
    <html>
    <head>
        <title>Legacy E-commerce App</title>
        <style>
    ...
    <body>
        <h1>🏪 Legacy E-commerce Application</h1>
        <p><strong>Status:</strong> Running on EC2</p>
        <h3>API Endpoints:</h3>
        <ul>
            <li><a href="/api/health">/api/health</a> - Health check</li>
            <li><a href="/api/products">/api/products</a> - Product catalog</li>
        </ul>
